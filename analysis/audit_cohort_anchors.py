...
synthesises Hg-1201 and Hg-1212 and reports Tc of 78 K and 124 K; neither the
...
def main():
    ...
    cols = ["identifier", "compound", "substructure_family", "Tc_anchor_K",
            ...
            "pdf", "tc_in_paper", "hc2_in_paper", "compound_elements_in_paper",
            "verdict"]
    ...
    for r in rows:
        ...
        # Every element of the recorded compound should at least occur in the text.
        ...
        out.update(pdf=os.path.basename(path), tc_in_paper=tc_ok,
                   hc2_in_paper=hc2_ok, compound_elements_in_paper=el_ok,
                   verdict=verdict)
        w.writerow(out)
        if verdict != "ok":
