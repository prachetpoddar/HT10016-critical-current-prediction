...
txt(137.5, 88.4, "the family label accounts for", size=7.0)
txt(137.5, 86.6, "0.52 of the temperature-exponent", size=7.0)
txt(137.5, 84.8, "variance between papers,", size=7.0)
txt(137.5, 83.0, "permutation p = 0.007 (Sec. III.C)", size=7.0)
