...
rows=[("934","articles retrieved and screened",9.6,1.00),
      ("65","papers contributing fitted curves",7.9,0.74),
      ("40","distinct compounds",6.2,0.56),
      ("4247","extracted critical-current points",4.5,0.56),
      ("23","compounds fittable on both axes",2.8,0.34),
      ("105","per-paper anchors behind Fig. 3",1.2,0.44)]
for n,(val,lab,y,w) in enumerate(rows):
    ...
    axA.text(x0+0.28,y-0.13,val,fontsize=11,fontweight="bold",color=ACC if n in (1,4) else INK,va="center",zorder=3)
...
fams=[("Iron chalcogenide 11-type",29,29,0),("Iron pnictide 122-type",51,9,42),(r"MgB$_2$-class",103,85,18)]
y=8.5
...
axB.text(0.78,0.87,"refused: no critical-field anchor",fontsize=7.3,color="#454C57",va="center")
axB.text(0.2,0.05,"123 of 183 candidate compounds receive at least one prediction.",
